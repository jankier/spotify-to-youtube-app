...
import NewPlaylistFinalizationPage from "./components/NewPlaylistFinalizationPage";
import ExistingPlaylistFinalizationPage from "./components/ExistingPlaylistFinalizationPage";
    ...
    <div className="h-screen flex flex-col bg-stone-50 dark:bg-gray-800">
      ...
      <div className="bg-stone-50 dark:bg-gray-800 overflow-auto">
        <Routes>
          <Route
            index
            element={<IndexPage user={user} setPlaylist={setPlaylist} />}
          />
          <Route
            path="/ExistingPlaylistFinalizationPage"
            element={
              <ExistingPlaylistFinalizationPage
                user={user}
                playlist={playlist}
              />
            }
          />
          <Route
            path="/NewPlaylistFinalizationPage"
            element={
              <NewPlaylistFinalizationPage user={user} playlist={playlist} />
            }
          />
