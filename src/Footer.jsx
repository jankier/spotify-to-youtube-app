function Footer() {
    return (
      <div className="text-xs md:text-lg font-semibold absolute right-0 left-0 bottom-0 p-5 bg-amber-300 dark:bg-gray-900 flex items-center justify-between shadow">
